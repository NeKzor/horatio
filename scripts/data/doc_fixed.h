...
struct Array {
	...
	ElemType operator[](class CNod Object);
...
*/
	class CUser * const  LocalUser;
/*!

*/
	class CTitle * const  LoadedTitle;
/*!

*/
	Array<class CMlScriptEvent* const > PendingEvents;
/*!
...
*/
	Void EnableMenuNavigation(Boolean EnableInputs,Boolean WithAutoFocus,class CMlControl AutoBackControl,Integer InputPriority);
/*!
...
*/
	class CParsingManager * const  Xml;
/*!

*/
	class CHttpManager * const  Http;
/*!

*/
	class CVideoManager * const  Video;
/*!

*/
	class CAudioManager * const  Audio;
/*!

*/
	class CInputManager * const  Input;
/*!

*/
	class CDataFileMgr * const  DataFileMgr;
/*!

*/
	class CScoreMgr * const  ScoreMgr;
/*!

*/
	class CRankingsZoneMgr * const  ZoneMgr;
/*!

*/
	class CUserV2Manager * const  UserMgr;
/*!

*/
	class CAnimManager * const  AnimMgr;
/*!

*/
	class CMenuSceneManager * const  MenuSceneMgr;
/*!

*/
	class CSystemPlatform * const  System;
/*!

*/
	class CWSNotificationManager * const  WSNotificationMgr;
/*!
...
*/
	Text Dbg_DumpDeclareForVariables(class CNod Nod,Boolean StatsOnly);
/*!
...
*/
	Array<class CUILayer* const > UILayers;
/*!

*/
	class CUILayer UILayerCreate();
/*!

*/
	Void UILayerDestroy(class CUILayer Layer);
/*!
...
*/
	class CTrackingMgr * const  TrackingMgr;
/*!
...
*/
	Array<class CManiaAppEvent* const > PendingEvents;
/*!

*/
	class CEditorModule * const  ModuleEditor;
/*!

*/
	class CEditorMesh * const  MeshEditor;
/*!

*/
	class CEditorEditor * const  EditorEditor;
/*!

*/
	class CEditorMediaTracker * const  MediaTracker;
/*!

*/
	class CEditorSkin * const  SkinEditor;
/*!
...
*/
	class CEditorPluginHandle GetPluginHandle(Text Name);
/*!

*/
	Void SendPluginEvent(class CEditorPluginHandle Handle,Text Type,Array<Text> Data);
/*!
...
*/
	Array<class CGameModuleEditorBase* const > Modules;
};
...
*/
	class CMapInfo * const  MapInfo;
/*!

*/
	class CClient GetClient(Text Login);
/*!

*/
	class CClient GetClient(class CUIConfig UI);
/*!

*/
	class CClient GetClient(CUser Login);
/*!

*/
	class CClient GetClientFromWebServicesUserId(Text WebServicesUserId);
/*!
Currently connected Users.
*/
	Array<class CClient* const > Clients;
/*!
Users connected as spectators.
*/
	Array<class CClient* const > Spectators;
/*!
Users connected as players.
*/
	Array<class CClient* const > Players;
/*!

*/
	class CPlayer GetPlaygroundPlayer(Text Login);
/*!
Sorted scores.
*/
	Array<class CScore* const > Scores;
/*!

*/
	Array<class CUser* const > Users;
/*!

*/
	Array<class CTeam* const > Teams;
/*!
...
*/
	Array<class CServerPluginEvent* const > PendingEvents;
/*!
...
*/
	class CUIConfigMgr * const  UIManager;
/*!

*/
	class CServerAdmin * const  ServerAdmin;
/*!

*/
	class CXmlRpc * const  XmlRpc;
/*!
...
*/
	Array<class CTaskResult* const > TaskResults;
/*!
...
*/
	Array<class CGhost* const > Ghosts;
/*!

*/
	class CTaskResult_Ghost Ghost_Download(Text Url);
/*!
...
namespace NWebServicesPrestige {
...
*/
	Array<class CSkinInfo*> InvitedSkinList;
/*!
...
*/
	class CTrophyAchievement * TrophyAchievement;
};
...
*/
	class CTrophyAchievement_CompetitionMatch * TrophyAchievement_CompetitionMatch;
};
...
*/
	class CTrophyAchievement_CompetitionRanking * TrophyAchievement_CompetitionRanking;
};
...
*/
	class CTrophyAchievement_LiveMatch * TrophyAchievement_LiveMatch;
};
...
*/
	class CTrophyAchievement_SoloMedal * TrophyAchievement_SoloMedal;
};
...
*/
	class CTrophyAchievement_SoloRanking * TrophyAchievement_SoloRanking;
};
...
*/
	Array<class CMapInfo* const > MapList;
/*!
...
*/
	class CModulePlaygroundHud * const  Hud;
/*!

*/
	Void PassOn(class CUIConfigEvent EventToPassOn);
/*!

*/
	Void Discard(class CUIConfigEvent EventToDiscard);
/*!
...
*/
	Void Ladder_AddPlayer(class CScore PlayerScore);
/*!
...
*/
	Void Ladder_OpenMatch_AddPlayer(class CScore PlayerScore);
/*!
...
*/
	class CTaskResult_AccountTrophyGainList Trophy_CompetitionMatch_SendResultList(Text CompetitionName,Text CompetitionStage,Text CompetitionStageStep,Text CompetitionMatchInfo);
/*!
...
*/
	class CTaskResult_AccountTrophyGainList Trophy_LiveTimeAttackAchievement_SendResultList(Integer Duration);
/*!
...
*/
	Void Solo_SetNewRecord(class CScore PlayerScore,CMode::EMedal PlayerMedal);
/*!
...
*/
	Boolean Users_AreAllies(class CUser User1,class CUser User2);
/*!

*/
	Void Users_RequestSwitchToSpectator(class CUser User);
/*!

*/
	class CUser Users_CreateFake(Text NickName,Integer RequestedTeam);
/*!

*/
	Void Users_DestroyFake(class CUser User);
/*!
...
*/
	Void DemoToken_GetAndUseToken(class CUser User);
/*!
...
*/
	class CModeTurretManager * const  TurretsManager;
/*!

*/
	class CModeVehicleManager * const  VehiclesManager;
/*!

*/
	class CActionManager * const  ActionsManager;
/*!
...
*/
	Void GhostDriver_Playlist_Clear(class CPlayer Player);
/*!

*/
	Void GhostDriver_Playlist_Add(class CPlayer Player,CGhost Ghost);
/*!
...
*/
	class CWebServicesTaskResult_GhostDriver_UploadLimits GhostDriver_UploadLimits_End();
/*!
...
*/
	Void GhostDriver_Upload_AddGhost(class CGhost Ghost);
/*!
...
*/
	class CTaskResult GhostDriver_Upload_End();
/*!
...
*/
	class CWebServicesTaskResult_GhostDriver_Download GhostDriver_Download_End();
/*!

*/
	class CTaskResult_MapRecordList MapRecord_GetListByMapAndPlayerList(Ident UserId,Array<Text> WebServicesUserIdList,Text MapUid,Text ScopeType,Text ScopeId,Text GameMode,Text GameModeCustomData);
/*!
...
*/
	Array<class CSmPlayer* const > Players;
/*!

*/
	Array<class CSmPlayer* const > BotPlayers;
/*!

*/
	Array<class CSmPlayer* const > Spectators;
/*!

*/
	Array<class CSmPlayer* const > AllPlayers;
/*!

*/
	Array<class CSmModeEvent* const > PendingEvents;
/*!

*/
	class CSmPlayer GetPlayer(CUIConfig UI);
/*!

*/
	class CSmPlayer GetPlayer(Text Login);
/*!

*/
	Array<class CSmMapBase* const > MapBases;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_PlayerSpawn;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_Gauge;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_Sector;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_BotPath;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_BotSpawn;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_ObjectAnchor;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_Gate;
/*!

*/
	Array<class CSmMapLandmark* const > MapLandmarks_Foundation;
/*!
...
*/
	Array<class CSmScore* const > Scores;
/*!
...
*/
	Void SpawnPlayer(CSmPlayer Player,Integer ClanNum,Integer Armor,class CMapSpawn PlayerSpawn,Integer ActivationDate);
/*!

*/
	Void SpawnPlayer(CSmPlayer Player,Integer ClanNum,class CModeTurret Turret,Integer ActivationDate);
/*!

*/
	Void SpawnPlayer(CSmPlayer Player,Integer ClanNum,class CModeVehicle Vehicle,Integer ActivationDate);
/*!

*/
	Void SpawnPlayer(CSmPlayer Player,Integer ClanNum,class CModeVehicle Vehicle,Integer SlotIndex,Integer ActivationDate);
/*!

*/
	Void SpawnBotPlayer(CSmPlayer Player,Integer ClanNum,Integer Armor,class CMapSpawn PlayerSpawn,Integer ActivationDate);
/*!

*/
	Void SpawnBotPlayer(CSmPlayer Player,Integer ClanNum,Integer Armor,class CMapBotPath BotPath,Integer ActivationDate);
/*!

*/
	Void SpawnBotPlayer(CSmPlayer Player,Integer ClanNum,Integer Armor,class CMapBotSpawn BotSpawn,Integer ActivationDate);
/*!
...
*/
	Void Entity_AddArmor(class CEntity Victim,Integer DeltaArmor,class CEntity Shooter,Integer ShooterPoints);
/*!

*/
	Void Entity_RemoveArmor(class CEntity Victim,Integer DeltaArmor,class CEntity Shooter,Integer ShooterPoints);
/*!

*/
	Void Entity_TriggerTurbo(class CEntity Target,Integer StartTime);
/*!
...
*/
	Void RespawnPlayer(CSmPlayer Player,class CMapWaypoint Waypoint);
/*!
...
*/
	Array<class CSmObject* const > Objects;
/*!

*/
	class CSmObject ObjectCreate(Ident ModelId);
/*!

*/
	Void ObjectDestroy(class CSmObject Object);
/*!
...
*/
	class CGhostManager * const  GhostMgr;
/*!
...
public :
	...
	*/
	enum class MapElemLightmapQuality {
		Normal,
		High,
		VeryHigh,
		Highest,
...
*/
	Array<class CMapEditorPluginEvent* const > PendingEvents;
/*!
...
*/
	Void TestMapFromMacroblockInstance(class CMacroblockInstance MbInstance);
/*!
...
*/
	class CMapEditorInventory * const  Inventory;
/*!
...
*/
	Boolean CanPlaceBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir,Boolean OnGround,class Integer VariantIndex);
/*!

*/
	Boolean PlaceBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean CanPlaceGhostBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean PlaceGhostBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean CanPlaceBlock_NoDestruction(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir,Boolean OnGround,class Integer VariantIndex);
/*!

*/
	Boolean PlaceBlock_NoDestruction(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean CanPlaceRoadBlocks(class CBlockModel BlockModel,Int3 StartCoord,Int3 EndCoord);
/*!

*/
	Boolean PlaceRoadBlocks(class CBlockModel BlockModel,Int3 StartCoord,Int3 EndCoord);
/*!

*/
	Boolean CanPlaceTerrainBlocks(class CBlockModel BlockModel,Int3 StartCoord,Int3 EndCoord);
/*!

*/
	Boolean PlaceTerrainBlocks(class CBlockModel BlockModel,Int3 StartCoord,Int3 EndCoord);
/*!

*/
	Boolean PlaceTerrainBlocks_NoDestruction(class CBlockModel BlockModel,Int3 StartCoord,Int3 EndCoord);
/*!

*/
	Boolean CanPlaceMacroblock(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean PlaceMacroblock(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean PlaceMacroblock_AirMode(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean CanPlaceMacroblock_NoDestruction(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean PlaceMacroblock_NoDestruction(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean CanPlaceMacroblock_NoTerrain(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean PlaceMacroblock_NoTerrain(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean RemoveMacroblock(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean RemoveMacroblock_NoTerrain(class CMacroblockModel MacroblockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	class CBlock GetBlock(Int3 Coord);
/*!

*/
	class CBlock GetBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	class CBlock GetGhostBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean IsBlockModelSkinnable(class CBlockModel BlockModel);
/*!

*/
	Integer GetNbBlockModelSkins(class CBlockModel BlockModel);
/*!

*/
	Text GetBlockModelSkin(class CBlockModel BlockModel,Integer SkinIndex);
/*!

*/
	Boolean IsItemModelSkinnable(class CGameItemModel ItemModel);
/*!

*/
	Integer GetNbItemModelSkins(class CGameItemModel ItemModel);
/*!

*/
	Text GetItemModelSkin(class CGameItemModel ItemModel,Integer SkinIndex);
/*!
...
*/
	Text GetBlockSkinBg(class CBlock Block);
/*!

*/
	Text GetBlockSkinFg(class CBlock Block);
/*!

*/
	Void SetBlockSkin(class CBlock Block,Text SkinFileName);
/*!

*/
	Void SetBlockSkins(class CBlock Block,Text BgSkinFileName,Text FgSkinFileName);
/*!

*/
	Text GetItemSkinBg(class CItemAnchor AnchoredObject);
/*!

*/
	Text GetItemSkinFg(class CItemAnchor AnchoredObject);
/*!

*/
	Void SetItemSkin(class CItemAnchor AnchoredObject,Text SkinFileName);
/*!

*/
	Void SetItemSkins(class CItemAnchor AnchoredObject,Text BgSkinFileName,Text FgSkinFileName);
/*!

*/
	Boolean IsSkinForeground(class CBlockModel BlockModel,Text SkinFileName);
/*!

*/
	Boolean IsSkinForeground(class CGameItemModel ItemModel,Text SkinFileName);
/*!

*/
	Boolean IsMacroblockModelSkinnable(class CMacroblockModel BlockModel);
/*!

*/
	Boolean SetMacroblockSkin(class CMacroblockInstance Macroblock,Text SkinFileName);
/*!
...
*/
	Boolean RemoveBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!

*/
	Boolean RemoveGhostBlock(class CBlockModel BlockModel,Int3 Coord,CMapEditorPlugin::CardinalDirections Dir);
/*!
...
*/
	Integer GetBlockGroundHeight(class CBlockModel BlockModel,Integer CoordX,Integer CoordZ,CMapEditorPlugin::CardinalDirections Dir);
/*!
...
*/
	Boolean RemoveItem(class CAnchorData Item);
/*!
...
*/
	class CBlockClipList CreateFrameClipList();
/*!

*/
	class CBlockClipList CreateFixedClipList();
/*!
...
*/
	CMacroblockInstance GetMacroblockInstanceConnectedToClip(class CBlockClip Clip);
/*!
...
*/
	class CMapEditorCamera * const  Camera;
/*!

*/
	class CMapEditorCursor * const  Cursor;
/*!
...
*/
	Array<class CMapEditorConnectResults* const > ConnectResults;
/*!
...
*/
	Array<class CSmActionEvent* const > PendingEvents;
/*!
...
*/
	class CPlaygroundClient * const  Playground;
/*!
...
*/
	class CManiaAppPlaygroundCommon * const  ParentApp;
/*!
...
*/
	class CGameUserVoiceChat * const  Sender;
/*!

*/
	class CGameUserVoiceChat * const  Destination;
/*!
...
namespace NGameScriptChat {

/*!
* \brief Documentation for class SEvent
*/
class SEvent {
public :
};
...
/*!
* \brief Documentation for class SEvent_NewEntry
*/
class SEvent_NewEntry : public SEvent {
public :
/*!
...
/*!
* \brief Documentation for class SEvent_HistoryChange
*/
class SEvent_HistoryChange : public SEvent {
public :
};
...
/*!
* \brief Documentation for class SEntry
*/
class SEntry {
public :
/*!
...
*/
	class SConstStringInt * const  Text;
/*!

*/
	class SConstString * const  SenderLogin;
/*!

*/
	class SConstStringInt * const  SenderDisplayName;
/*!

*/
	class SConstStringInt * const  SenderFullDisplayName;
/*!

*/
	class SConstStringInt * const  SenderFullDisplayName_ForTTS;
/*!

*/
	class SConstStringInt * const  SenderTeamColorText;
/*!
...
/*!
* \brief Documentation for class SHistory
*/
class SHistory {
public :
/*!
...
*/
	Array<SEvent*> PendingEvents;
};

/*!
* \brief Documentation for class SContext
*/
class SContext {
public :
/*!
...
*/
	Array<SHistory*> Histories;
/*!

*/
	SHistory History_Create(Text Filter,Integer MaxSize);
/*!

*/
	Void History_Destroy(SHistory History);
};
...
Will be Null if the script is not runing in a layer of an app.
*/
	class CManiaAppTitle * const  ParentApp;
/*!

*/
	class CTitleControl * const  TitleControl;
};
...
*/
	class CMapEditorPlugin * const  Editor;
};
...
Will be Null if the script is not runing in a layer of an app.
*/
	class CManiaAppStation * const  ParentApp;
/*!

*/
	class CStation * const  Station;
/*!
...
Will be Null if the script is not runing in a layer of an app.
*/
	class CManiaAppBrowser * const  ParentApp;
/*!
...
*/
	class CMlFrame * const  MainFrame;
/*!
...
*/
	class CParsingDocument Create(Text Contents);
/*!

*/
	class CParsingDocument Create(Text Contents,Boolean GenerateText,Boolean GenerateTextRaw,Boolean GenerateTextResursive);
/*!

*/
	Void Destroy(class CParsingDocument Document);
/*!
Parses an XML document
*/
	class CParsingDocument Parse_Xml(Text Contents);
/*!
Parses an XML document
*/
	class CParsingDocument Parse_Xml(Text Contents,Boolean GenerateText,Boolean GenerateTextRaw,Boolean GenerateTextResursive);
/*!

*/
	Void Parse_Destroy(class CParsingDocument Document);
/*!
...
*/
	Array<class CParsingDocument* const > DocumentsXml;
/*!
...
*/
	class CHttpRequest CreateGet(Text Url);
/*!

*/
	class CHttpRequest CreateGet(Text Url,Boolean UseCache);
/*!

*/
	class CHttpRequest CreateGet(Text Url,Boolean UseCache,Text AdditionalHeaders);
/*!

*/
	class CHttpRequest CreatePost(Text Url,Text Resource);
/*!

*/
	class CHttpRequest CreatePost(Text Url,Text Resource,Text AdditionalHeaders);
/*!

*/
	class CHttpRequest CreatePostFile(Text Url,Text FileName,Text AdditionalHeaders);
/*!

*/
	Void Destroy(class CHttpRequest Request);
/*!
...
*/
	Array<class CHttpRequest* const > Requests;
/*!
...
*/
	Array<class CHttpEvent* const > PendingEvents;
/*!
...
*/
	class CVideo CreateVideo(Text Url,Boolean IsLooping,Boolean AutoProcessing);
/*!

*/
	Void DestroyVideo(class CVideo Video);
/*!

*/
	Array<class CVideo* const > Videos;
};
...
*/
	class CAudioSource CreateSound(Text Url);
/*!

*/
	class CAudioSource CreateSound(Text Url,Real VolumedB,Boolean IsMusic,Boolean IsLooping,Boolean IsSpatialized);
/*!

*/
	Void DestroySound(class CAudioSource Sound);
/*!

*/
	Array<class CAudioSource* const > Sounds;
/*!

*/
	class CAudioSourceMusic CreateMusic(Text Url);
/*!

*/
	Void DestroyMusic(class CAudioSourceMusic Music);
/*!

*/
	Void PlaySoundEvent(class CAudioSource Sound,Real VolumedB);
/*!
...
*/
	Void PlaySoundEvent(class CAudioSource Sound,Real VolumedB,Integer Delay);
/*!
...
*/
	Array<class CInputEvent* const > PendingEvents;
/*!
...
*/
	Array<class CInputPad* const > Pads;
/*!
...
Array of campaigns.
*/
	Array<class CCampaign* const > Campaigns;
/*!
Get a campaign from its id.
*/
	class CCampaign Campaign_Get(Text CampaignId);
/*!

*/
	class CTaskResult_NSItemCollection ItemCollection_Create(Ident UserId,Text ClubId,Text DisplayName,Text FileName);
/*!

*/
	class CTaskResult_NSItemCollection ItemCollection_CreateVersion(Ident UserId,Text ItemCollectionId,Text FileName);
/*!
...
*/
	class CTaskResult_NSItemCollectionList ItemCollection_GetList(Ident UserId,Array<Text> ItemCollectionIdList);
/*!

*/
	class CTaskResult_NSItemCollectionList ItemCollection_GetListByUser(Ident UserId,Text WebServicesUserId);
/*!
...
*/
	class CTaskResult_MapList Map_GetGameList(Text Path,Boolean Flatten);
/*!
Get the list of map stored according to the filters in the specified path.
*/
	class CTaskResult_MapList Map_GetGameList(Text Path,Boolean Flatten,Boolean SortByNameElseByDate,Boolean SortOrderAsc);
/*!
...
*/
	class CTaskResult_MapList Map_GetFilteredGameList(Integer Scope,Text Path,Boolean Flatten,Boolean SortByNameElseByDate,Boolean SortOrderAsc);
/*!
...
*/
	class CTaskResult_NSMap Map_NadeoServices_Get(Ident UserId,Text MapId);
/*!

*/
	class CTaskResult_NSMap Map_NadeoServices_GetFromUid(Ident UserId,Text MapUid);
/*!

*/
	class CTaskResult_NSMapList Map_NadeoServices_GetList(Ident UserId,Array<Text> MapIdList);
/*!

*/
	class CTaskResult_NSMapList Map_NadeoServices_GetListFromUid(Ident UserId,Array<Text> MapUidList);
/*!

*/
	class CTaskResult_NSMapList Map_NadeoServices_GetListFromUser(Ident UserId,Text WebServicesUserId);
/*!

*/
	class CTaskResult_NSMap Map_NadeoServices_Register(Ident UserId,Text MapUid);
/*!

*/
	class CTaskResult_NSSkin Skin_NadeoServices_Get(Ident UserId,Text SkinId);
/*!

*/
	class CTaskResult_NSSkin Skin_NadeoServices_GetFromChecksum(Ident UserId,Text SkinChecksum);
/*!

*/
	class CTaskResult_NSSkinList Skin_NadeoServices_GetList(Ident UserId,Array<Text> SkinIdList);
/*!

*/
	class CTaskResult_NSSkinList Skin_NadeoServices_GetListFromChecksum(Ident UserId,Array<Text> SkinChecksumList);
/*!

*/
	class CTaskResult_NSSkinList Skin_NadeoServices_GetListFromUser(Ident UserId,Text WebServicesUserId);
/*!

*/
	class CTaskResult_NSSkin Skin_NadeoServices_Register(Ident UserId,Text SkinDisplayName,Text SkinFileName);
/*!

*/
	class CTaskResult AccountSkin_NadeoServices_AddFavorite(Ident UserId,Text SkinId);
/*!

*/
	class CTaskResult_NSSkinList AccountSkin_NadeoServices_GetFavoriteList(Ident UserId);
/*!

*/
	class CTaskResult_NSSkinList AccountSkin_NadeoServices_GetList(Ident UserId);
/*!

*/
	class CTaskResult_NSSkinList AccountSkin_NadeoServices_GetListForUser(Ident UserId,Text WebServicesUserId);
/*!

*/
	class CTaskResult AccountSkin_NadeoServices_RemoveFavorite(Ident UserId,Text SkinId);
/*!

*/
	class CTaskResult_NSSkin AccountSkin_NadeoServices_Set(Ident UserId,Text SkinId);
/*!

*/
	class CTaskResult AccountSkin_NadeoServices_Unset(Ident UserId,Text SkinType);
/*!
Array of ghosts.
*/
	Array<class CGhost* const > Ghosts;
...
*/
	class CTaskResult_Ghost Ghost_Download(Text FileName,Text Url);
/*!

*/
	class CTaskResult Ghost_Upload(Text Url,CGhost Ghost,Text AdditionalHeaders);
/*!
...
*/
	class CTaskResult_ReplayList Replay_GetGameList(Text Path,Boolean Flatten);
/*!
Get the list of replay stored according to the filters in the specified path.
*/
	class CTaskResult_ReplayList Replay_GetGameList(Text Path,Boolean Flatten,Boolean SortByNameElseByDate,Boolean SortOrderAsc);
/*!
...
*/
	class CTaskResult_ReplayList Replay_GetFilteredGameList(Integer Scope,Text Path,Boolean Flatten,Boolean SortByNameElseByDate,Boolean SortOrderAsc);
/*!
Get the list of ghosts from the replay stored at the specified file path.
*/
	class CTaskResult_GhostList Replay_Load(Text Path);
/*!
...
*/
	class CTaskResult_FileList Media_GetGameList(CDataFileMgr::EMediaType Type,Text Path,Boolean Flatten);
/*!
Get the list of media stored according to the filters in the specified path.
*/
	class CTaskResult_FileList Media_GetGameList(CDataFileMgr::EMediaType Type,Text Path,Boolean Flatten,Boolean SortByNameElseByDate,Boolean SortOrderAsc);
/*!
...
*/
	class CTaskResult_FileList Media_GetFilteredGameList(CDataFileMgr::EMediaType Type,Integer Scope,Text Path,Boolean Flatten,Boolean SortByNameElseByDate,Boolean SortOrderAsc);
/*!
...
*/
	class CTaskResult_GameModeList GameMode_GetGameList(Integer Scope,Text Path,Boolean Flatten);
/*!
...
*/
	class CWebServicesTaskResult_Natural MapLeaderBoard_GetPlayerRankingAsync(Ident UserId,Text MapUid,Text Context,Text Zone);
/*!
...
*/
	class CTaskResult_BuddiesChallengeRecord Campaign_GetBuddiesMapRecord(Ident UserId,Text CampaignId,Text MapUid);
/*!
...
*/
	class CTaskResult_BuddiesChallengeRecordsComparison Campaign_GetBuddiesMapRecordsComparison(Ident UserId,Text CampaignId);
/*!
Returns the records comparison with a buddy for a campaign.
*/
	class CTaskResult_BuddyChallengeRecordsComparison Campaign_GetBuddyMapRecordsComparison(Ident UserId,Text OpponentLogin,Text CampaignId);
/*!
...
*/
	class CTaskResult_NaturalLeaderBoardInfoList CampaignLeaderBoard_GetPlayerList(Ident UserId,Text CampaignId,Text Zone,Boolean UseSkillPoints,Integer FromIndex,Integer Count);
/*!
Creates a new season.
*/
	class CTaskResult_Season Season_Create(Ident UserId,Text SeasonName,Text GameMode,Text GameModeCustomData,Text MapRecordType,Integer StartTimeStamp,Integer EndTimeStamp,Array<Text> MapUidList);
/*!

*/
	class CTaskResult_Season Season_Update(Ident UserId,Text SeasonId,Text SeasonName,Text GameMode,Text GameModeCustomData,Text MapRecordType,Integer StartTimeStamp,Integer EndTimeStamp,Array<Text> MapUidList);
/*!

*/
	class CTaskResult_Season Season_AddMapList(Ident UserId,Text SeasonId,Array<Text> MapUidList);
/*!

*/
	class CTaskResult_Season Season_RemoveMapList(Ident UserId,Text SeasonId,Array<Text> MapUidList);
/*!
Returns the season info from a season id.
*/
	class CTaskResult_Season Season_Get(Ident UserId,Text SeasonId);
/*!
Returns a list of season info from a list of season id.
*/
	class CTaskResult_SeasonList Season_GetList(Ident UserId,Array<Text> SeasonIdList);
/*!
Returns the list of created season from a webservices user id.
*/
	class CTaskResult_SeasonList Season_GetListFromUser(Ident UserId,Text WebServicesUserId);
/*!
...
*/
	class CTaskResult_RealLeaderBoardInfoList GlobalLeaderBoard_GetPlayerList(Ident UserId,Text Zone,Integer FromIndex,Integer Count);
/*!
Returns the account trophy history.
*/
	class CTaskResult_AccountTrophyGainHistory Trophy_GetGainHistory(Ident UserId,Integer Offset,Integer Count);
/*!
Returns the account trophy history filtered by the specified type.
*/
	class CTaskResult_AccountTrophyGainHistory Trophy_GetGainHistoryByType(Ident UserId,Integer TrophyType,Integer Offset,Integer Count);
/*!
Returns the account trophy summary for the last year.
*/
	class CTaskResult_AccountTrophyLastYearSummary Trophy_GetLastYearSummary(Ident UserId);
/*!
Returns the account trophy summary for the last year for the specified user
*/
	class CTaskResult_AccountTrophyLastYearSummary Trophy_GetLastYearSummaryForUser(Ident UserId,Text WebServicesUserId);
/*!
Returns the trophy solo medal achievement settings
*/
	class CTaskResult_TrophySoloMedalAchievementSettings Trophy_GetSoloMedalAchievementSettings(Ident UserId,Text SoloMedalAchievementType);
};
...
*/
	class CTaskResult_ZoneList GetZoneList(Array<Text> ZoneIdList);
/*!

*/
	class CTaskResult_ZoneList GetChildZoneList(Text ZoneFullPath);
/*!

*/
	class CTaskResult_UserZoneList RetrieveUserZoneList(Ident UserId,Array<Text> WebServicesUserIdList);
/*!

*/
	class CTaskResult SetUserZone(Ident UserId,Text ZoneFullPath);
};
...
*/
	class CUserV2Profile * const  MainUserProfile;
/*!
...
*/
	class CTaskResult TaskError_ShowSystemDialog(Ident UserId,Text ErrorCode);
/*!
NullId for the mainuser.
*/
	class CTaskResult_StringIntList GetGroups(Ident UserId);
/*!
...
*/
	class CMasterServerUser * const  MainUserWebServicesInfo;
/*!
...
*/
	class CMasterServerUser FindWebServicesUserInfo(Ident UserId);
/*!

*/
	class CTaskResult CheckNetworkAvailability(Ident UserId);
/*!
...
*/
	class CTaskResult_Connect ConnectUser(Ident UserId);
/*!

*/
	class CTaskResult_Connect ConnectUser(Ident UserId,Boolean ForceUbisoftConnectOverlay);
/*!

*/
	class CTaskResult ConnectUser(Ident UserId,Boolean ForceUbisoftConnectOverlay,Boolean OfflineMode);
/*!

*/
	class CTaskResult Commerce_ShowPrimaryStore(Ident UserId);
/*!

*/
	class CTaskResult_Bool CrossPlay_IsEnabled(Ident UserId);
/*!
...
*/
	class CTaskResult_FriendList Friend_GetList(Ident UserId);
/*!

*/
	class CTaskResult_Session_Get LiveSession_GetInfo(Ident UserId,Text SessionId);
/*!

*/
	class CTaskResult_UserNewsList News_GetProfileNewsList(Ident UserId);
/*!

*/
	class CTaskResult_UserNewsList News_GetSpaceNewsList(Ident UserId);
/*!
...
*/
	class CTaskResult_UserPrestigeList Prestige_GetAccountPrestigeList(Ident UserId);
/*!

*/
	class CTaskResult_UserPrestige Prestige_GetCurrentAccountPrestige(Ident UserId);
/*!

*/
	class CTaskResult_UserPrestige Prestige_GetCurrentAccountPrestigeForUser(Ident UserId,Text WebServicesUserId);
/*!

*/
	class CTaskResult_PrestigeList Prestige_GetPrestigeList(Ident UserId,CUserV2Manager::EPrestigeMode Mode,Integer Year,Text CategoryType);
/*!

*/
	class CTaskResult_UserPrestige Prestige_SetCurrentAccountPrestige(Ident UserId,Text PrestigeId);
/*!

*/
	class CTaskResult_UserPrestige Prestige_ResetCurrentAccountPrestige(Ident UserId);
/*!

*/
	class CTaskResult_Squad Squad_AcceptInvitation(Ident UserId,Text SquadId);
/*!

*/
	class CTaskResult_Squad Squad_CancelInvitation(Ident UserId,Text SquadId,Text WebServicesUserId);
/*!

*/
	class CTaskResult_Squad Squad_Create(Ident UserId,Text SquadName,Integer Size);
/*!

*/
	class CTaskResult_Squad Squad_Create(Ident UserId,Text SquadName,Integer Size,Text Type);
/*!

*/
	class CTaskResult_Squad Squad_DeclineInvitation(Ident UserId,Text SquadId);
/*!

*/
	class CTaskResult_Squad Squad_Get(Ident UserId,Text SquadId);
/*!

*/
	class CTaskResult_Squad Squad_GetCurrent(Ident UserId);
/*!

*/
	class CTaskResult_Squad Squad_Invite(Ident UserId,Text SquadId,Text WebServicesUserId);
/*!

*/
	class CTaskResult Squad_JoinSession(Ident UserId,Text SessionId,Boolean IsFirstPartySession);
/*!

*/
	class CTaskResult_Squad Squad_Leave(Ident UserId,Text SquadId);
/*!

*/
	class CTaskResult_Squad Squad_RemoveMember(Ident UserId,Text SquadId,Text WebServicesUserId);
/*!

*/
	class CTaskResult_Squad Squad_SetLeader(Ident UserId,Text SquadId,Text WebServicesUserId);
/*!
...
*/
	Array<class CVoiceChatEvent* const > VoiceChat_Events;
/*!
...
*/
	Array<class CGameUserVoiceChat* const > VoiceChat_Users;
/*!

*/
	Array<class CGameUserVoiceChat* const > VoiceChat_Users_Local;
/*!

*/
	Array<class CGameUserVoiceChat* const > VoiceChat_Users_Remote;
/*!
List of users currently speaking. Sorted with local users first.
*/
	Array<class CGameUserVoiceChat* const > VoiceChat_Users_Speaking;
/*!

*/
	Array<class CGameUserVoiceChat* const > VoiceChat_Users_Muted;
/*!

*/
	Array<class CGameUserVoiceChat* const > VoiceChat_Users_Remote_Muted;
/*!

*/
	class CGameUserVoiceChat VoiceChat_FindUserFromWebServicesUserId(Text WebServicesUserId);
/*!
...
*/
	class CTaskResult_StringInt Tag_GetClubTag(Ident UserId);
/*!

*/
	class CTaskResult_ClubTagList Tag_GetClubTagList(Ident UserId,Array<Text> WebServicesUserIdList);
/*!
...
*/
	Void PlaneReflectEnable(Ident SceneId,Real OutOpacity,class CMlQuad Quad0,class CMlQuad Quad1,class CMlQuad Quad2,class CMlQuad Quad3);
/*!

*/
	Void PlaneReflectEnable(Ident SceneId,Real OutOpacity,class CMlQuad Quad0,class CMlQuad Quad1,class CMlQuad Quad2,class CMlQuad Quad3,Real HorizonAngleDeg_InCamera);
/*!
...
*/
	Void SetBackgroundQuads(Ident SceneId,class CMlQuad Quad0,class CMlQuad Quad1,class CMlQuad Quad2,class CMlQuad Quad3);
/*!
...
*/
	class CTaskResult_WSNotification Notification_PopNext(Ident UserId);
};
...
*/
	class CTitleEdition * const  TitleEdition;
/*!

*/
	class CNotificationsConsumer * const  Notifications;
/*!
...
*/
	class CMatchSettingsManager * const  MatchSettingsManager;
/*!
...
*/
	class CVoiceChatConfig * const  VoiceChat;
};
...
*/
	Array<class CUIConfigMarker* const > Markers;
/*!
...
*/
	Void Spectator_SetForcedTarget_Landmark(class CMapLandmark Landmark);
/*!
...
ServerInfo
*/
	class CServerInfo * const  ServerInfo;
/*!
...
*/
	Array<class CXmlRpcEvent* const > PendingEvents;
/*!
...
*/
	class CTmRaceResultNod * const  Result;
/*!
...
*/
	class CSmPlayerDriver * const  Driver;
/*!
Values in range (0.000000-1.000000)
*/
	Real AccelCoef;
...
*/
	class CMapObjectAnchor * const  ObjectAnchor;
};
...
*/
	class CSmMapGate * const  Gate;
/*!

*/
	class CSmMapGauge * const  Gauge;
};
...
namespace NSystemConfig {
	enum class EVoiceDetectionMode {};
}
...
*/
	class CModuleMenuModel * const  EditedMenu;
/*!

*/
	class CModuleMenuPageModel * const  EditedMenuPage;
/*!

*/
	class CModulePlaygroundHudModel * const  EditedPlaygroundHud;
/*!
...
*/
	Array<class CEditorPluginModuleEvent* const > PendingEvents;
/*!
...
*/
	class CImage MaterialPhysic_GetNextBitmap();
/*!
...
*/
	class CImage Material_GetBitmapBase(Ident MaterialId);
/*!

*/
	class CImage Material_GetBitmap(Ident MaterialId);
/*!

*/
	class CImage MaterialDyna_GetBitmap(Ident MaterialId);
/*!
...
*/
	Array<class CEditorEvent* const > PendingEvents;
/*!
...
public :
	...
	*/
	enum class EEditorFileToolBar_QuadType {
		Quit,
		New,
		Open,
		SaveAs,
...
public :
	...
	*/
	enum class EMediaTrackerBlockType {
		Ghost,
		CameraCustom,
		CameraPath,
		Time,
	...
	*/
	enum class EMediaTrackerCopyType {
		None,
		Key,
		Block,
	};
	...
	*/
	enum class EMediaTrackerPasteType {
		None,
		KeyInfo,
		NewKey,
		BlockCurrentTrack,
	...
	*/
	enum class EMediaTrackerGhostRef {
		Author,
		Ghost1,
		Ghost2,
		Ghost3,
...
*/
	class CMediaTrackerClip * const  Clip;
/*!

*/
	class CMediaTrackerClipGroup * const  ClipGroup;
/*!
...
*/
	Void SetTrackIsCycling(class CMediaTrackerTrack Track,Boolean IsCycling);
/*!

*/
	Void SetTrackIsKeepPlaying(class CMediaTrackerTrack Track,Boolean IsKeepPlaying);
/*!

*/
	Boolean GetTrackIsCycling(class CMediaTrackerTrack Track);
/*!

*/
	Boolean GetTrackIsKeepPlaying(class CMediaTrackerTrack Track);
/*!

*/
	Void SetStartIsCycling(class CMediaTrackerTrack Track);
/*!

*/
	Void SetStopIsCycling(class CMediaTrackerTrack Track);
/*!

*/
	Real GetStartIsCycling(class CMediaTrackerTrack Track);
/*!

*/
	Real GetStopIsCycling(class CMediaTrackerTrack Track);
/*!
...
public :
	...
	*/
	enum class EEditorSkin_IconType {
		Stickers,
		Brushs,
		Layers,
		SubObjects,
...
*/
	Void PlayMatchSettings(class CMatchSettings MatchSettings,Text OverrideMode,Text OverrideSettingsXml);
/*!
...
*/
	Void PlaySplitScreen(CTitleControl::ESplitScreenLayout LayoutType,class CMatchSettings MatchSettings);
/*!

*/
	Void PlayMultiOnSameScreen(class CMatchSettings MatchSettings);
/*!
...
*/
	Void CreateServer(Text ServerName,Text ServerComment,Integer MaxPlayerCount,Text Password,Text PasswordSpectators,class CMatchSettings MatchSettings);
/*!

*/
	Void CreateServer(Text ServerName,Text ServerComment,Integer MaxPlayerCount,Text Password,Text PasswordSpectators,class CMatchSettings MatchSettings,Boolean LocalOnly);
/*!
...
*/
	Array<class CPackCreatorTitleInfo* const > Maker_EditedTitles;
};
...
*/
	class CMlGraphCurve AddCurve();
/*!

*/
	Void RemoveCurve(class CMlGraphCurve Curve);
/*!

*/
	Array<class CMlGraphCurve*> Curves;
};
...
*/
	class CParsingNode * const  Root;
/*!

*/
	Array<class CParsingNode* const > Nodes;
/*!

*/
	class CParsingNode GetFirstChild(Text Name);
};
...
*/
	Array<class CMapGroup*> MapGroups;
/*!
...
*/
	class CMapGroup GetMapGroup(Integer Index);
/*!

*/
	class CMapInfo GetNextMap(class CMapInfo CurrentMapInfo);
/*!
...
*/
	class CNadeoServicesItemCollection * const  ItemCollection;
};
...
*/
	class CNadeoServicesMap * const  Map;
};
...
*/
	class CNadeoServicesSkin * const  Skin;
};
...
*/
	Array<class CReplayInfo* const > ReplayInfos;
/*!
List of the sub folders. Array of string.
*/
	Array<Text> SubFolders;
...
*/
	Array<class CTaskResult_ModeInfo* const > GameModes;
};
...
*/
	Array<class CMapRecord* const > MapRecordList;
};
...
*/
	Array<class CHighScoreComparison* const > BuddiesChallengeRecord;
/*!
...
*/
	Array<class CHighScoreComparisonSummary* const > BuddiesComparison;
/*!
...
*/
	Array<class CHighScoreComparison* const > PlayerBestRecordsComparison;
/*!
List of best challenge records for buddy. Array of CHighScoreComparison objects.
*/
	Array<class CHighScoreComparison* const > BuddyBestRecordsComparison;
/*!
...
*/
	Array<class CNaturalLeaderBoardInfo* const > LeaderBoardInfo;
};
...
*/
	Array<class CRealLeaderBoardInfo* const > LeaderBoardInfo;
};
...
*/
	class CAccountTrophyLastYearSummary * const  Summary;
};
...
*/
	class CTrophySoloMedalAchievementSettings * const  Settings;
};
...
public :
	...
	*/
	enum class EMapEditorDifficulty {
		Simple,
		Advanced,
		Expert,
	};
	...
	*/
	enum class ERoadsideSpectatorVisibility {
		Never,
		SpectatorOnly,
		Always,
	};
	...
	*/
	enum class EIngameChatBackground {
		Hidden,
		Transparent,
		Opaque,
	};
	...
	*/
	enum class EIngameChatTextSize {
		Medium,
		Small,
		Big,
	};
...
*/
	Array<class CVehicleSettings*> Inputs_Vehicles;
/*!
...
*/
	Array<class CFriend* const > FriendList;
};
...
*/
	Array<class CNews* const > NewsList;
};
...
*/
	Array<class CUserPrestige* const > UserPrestigeList;
};
...
*/
	class CUserPrestige * const  UserPrestige;
/*!
...
*/
	Array<class CPrestige* const > PrestigeList;
};
...
*/
	class CNotification * const  Notification;
};
...
*/
	class CPackCreator * const  PackCreator;
/*!
...
Events
*/
	Array<class CNotificationsConsumerEvent* const > Events;
/*!
List of the Notifications.
*/
	Array<class CNotificationsConsumerNotification* const > Notifications;
/*!

*/
	Array<class CNotificationsConsumerNotification* const > FilteredNotifications;
/*!
...
*/
	class CMacroblockModel * const  MacroblockModel;
/*!

*/
	class CBlockClipList * const  ClipList;
/*!
...
*/
	class CMapEditorInventoryDirectory * const  CurrentRootNode;
/*!

*/
	class CMapEditorInventoryDirectory * const  CurrentDirectory;
/*!

*/
	class CMapEditorInventoryNode * const  CurrentSelectedNode;
/*!

*/
	Array<class CMapEditorInventoryNode*> RootNodes;
/*!
...
*/
	Void SelectArticle(class CMapEditorInventoryArticle NodeArticle);
/*!

*/
	Void OpenDirectory(class CMapEditorInventoryDirectory NodeDirectory);
/*!

*/
	Void SelectNode(class CMapEditorInventoryNode Node);
/*!
...
*/
	CMapEditorInventoryDirectory GetDirectoryAfter(class CMapEditorInventoryNode Node);
/*!

*/
	CMapEditorInventoryDirectory GetDirectoryBefore(class CMapEditorInventoryNode Node);
/*!

*/
	CMapEditorInventoryArticle GetArticleAfter(class CMapEditorInventoryNode Node);
/*!

*/
	CMapEditorInventoryArticle GetArticleBefore(class CMapEditorInventoryNode Node);
};
...
*/
	class CBlockModelVariantGround * const  VariantGround;
/*!

*/
	class CBlockModelVariantAir * const  VariantAir;
};
...
*/
	Array<class CBlockUnit* const > BlockUnits;
/*!
...
*/
	class CModulePlaygroundInventory * Inventory;
/*!

*/
	class CModulePlaygroundStore * Store;
/*!

*/
	class CModulePlaygroundScoresTable * ScoresTable;
/*!

*/
	class CModulePlaygroundChrono * Chrono;
/*!

*/
	class CModulePlaygroundSpeedMeter * SpeedMeter;
/*!

*/
	class CModulePlaygroundPlayerState * PlayerState;
/*!

*/
	class CModulePlaygroundTeamState * TeamState;
/*!

*/
	Array<class CModulePlayground* const > Modules;
/*!

*/
	Void SwitchContext(class CPlayer Player,Text ContextName);
/*!

*/
	Void SetDefaultContext(class CPlayer Player);
/*!
...
*/
	class CActionInterface Action_GetState(CPlayer Player,CActionManager::EActionSlot Slot);
/*!

*/
	class CActionInterface Action_GetState(CModeVehicle Vehicle,Integer VehicleSlotIndex,CActionManager::EActionSlot Slot);
/*!

*/
	class CActionInterface Action_GetState(CModeTurret Turret,CActionManager::EActionSlot Slot);
/*!

*/
	Array<class CActionInterface*> Actions;
};
...
*/
	Array<class SWebServicesTaskResult_GhostDriver_UploadLimit*> Limits;
};
...
*/
	Array<class SWebServicesTaskResult_GhostDriver_Download_Team*> Teams;
};
...
public :
	...
	*/
	enum class ESpectatorTargetType {
		None,
		Single,
		AllPlayers,
		AllMap,
...
*/
	Array<class CManiaAppPlaygroundEvent* const > PendingEvents;
/*!
...
*/
	Void AddLink(class CModuleMenuPageModel ParentPage,class CModuleMenuPageModel ChildPage);
/*!
...
*/
	Array<class CHudModule* const > SubModules;
/*!

*/
	class CHudModule NewSubModule(Text ModulePath);
/*!

*/
	Void DeleteSubModule(class CHudModule SubModule);
/*!

*/
	Boolean SubModuleIsContextActive(class CHudModule SubModule,Ident ContextId);
/*!

*/
	Void SubModuleSetContextIsActive(class CHudModule SubModule,Ident ContextId,Boolean IsActive);
/*!
...
*/
	Array<class CMediaTrackerBlock* const > Blocks;
};
...
*/
	Array<class CMatchSettingsPlaylistItem* const > Playlist;
/*!
...
*/
	class CNadeoServicesItemCollectionVersion * CurrentVersion;
/*!
...
*/
	Array<class CSeasonMapInfo*> MapInfoList;
};
...
*/
	class CTrophySoloMedalAchievementLevelSettings * AllBronzeLevelSettings;
/*!

*/
	class CTrophySoloMedalAchievementLevelSettings * AllSilverLevelSettings;
/*!

*/
	class CTrophySoloMedalAchievementLevelSettings * AllGoldLevelSettings;
/*!

*/
	class CTrophySoloMedalAchievementLevelSettings * AllAuthorLevelSettings;
};
...
*/
	Array<class CNewsLink*> LinkList;
};
...
*/
	Array<class CSquadInvitation*> InvitationList;
/*!

*/
	Array<class CSquadMember*> MemberList;
};
...
*/
	class CPackCreatorPack * const  CurrentPack;
/*!
Start a new build for a pack, optionnaly a titlepack.
*/
	Ident Build_Begin(class CPackCreatorPack Pack,class CPackCreatorTitleInfo TitleInfo);
/*!
...
*/
	Array<class CBlockUnitModel* const > BlockUnitModels;
};
...
*/
	Array<class SWebServicesTaskResult_GhostDriver_Download_Member*> Members;
};
...
public :
	...
	*/
	enum class GameplaySpecialType {
		None,
		Turbo,
		Turbo2,
		TurboRoulette,
	...
	*/
	enum class GameplayTurboRoulette {
		TurboRoulette_None,
		TurboRoulette_1,
		TurboRoulette_2,
		TurboRoulette_3,
...
*/
	Array<class CPackCreatorRecipient* const > Recipients;
};
...
*/
	Array<class CBlockModelClip* const > Clips;
};
...
*/
	Array<class SWebServicesTaskResult_GhostDriver_Download_Ghost*> Ghosts;
};
